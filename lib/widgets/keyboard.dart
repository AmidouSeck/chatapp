...
typedef KeyboardTapAuthCallback = void Function();
...
class Keyboard extends StatelessWidget {
  ...
  final KeyboardTapAuthCallback onKeyboardAuthTap;
  ...
  Keyboard({
    ...
    required this.onKeyboardAuthTap,
    this.digits,
  }) : super(key: key);
  ...
  Widget _buildKeyboard(BuildContext context) {
    ...
    if (digits == null || digits!.isEmpty) {
      keyboardItems = ['1', '2', '3', '4', '5', '6', '7', '8', '9','touch','0','clear'];
    } else {
  ...
  Widget _buildKeyboardDigit(String text,context) {
      ...
      child: ClipOval(
        child: Material(
          ...
          child: InkWell(
            ...
            child: (text == "clear") ? Container() :  Container(
